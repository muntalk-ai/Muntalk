  ...
  return (
    <div style={{ minHeight:'100vh', background:'#fff', fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif", position:'relative' }}>
      ...
      <nav style={{ position:'sticky', top:0, zIndex:100, display:'flex', alignItems:'center', padding:'0 28px', height:56, background:'rgba(255,255,255,0.9)', backdropFilter:'blur(12px)', borderBottom:'1px solid #F1F5F9' }}>
        ...
        {user && (
          <div style={{ marginLeft:'auto' }}>
            {user.photoURL
              ? <img loading="lazy" src={user.photoURL} style={{ width:28,height:28,borderRadius:'50%',objectFit:'cover' }} alt="" />
      ...
      <div style={{ maxWidth:1040, margin:'0 auto', padding:'60px 20px 100px', position:'relative', zIndex:1 }}>
        ...
        {/* Comparison banner — positioning vs competitors */}
        <div style={{ background:'linear-gradient(135deg,#0F172A,#1E1B4B)', borderRadius:20, padding:'26px 30px', marginBottom:36, display:'flex', alignItems:'center', gap:20, flexWrap:'wrap', animation:'fadeUp .5s ease .1s both' }}>
          ...
          <div style={{ flex:1, minWidth:240 }}>
            <div style={{ fontSize:16, fontWeight:900, color:'#fff', marginBottom:6 }}>
              Other AI tutors charge up to <span style={{ color:'#F87171' }}>$30/mo</span> for AI conversation
            </div>
        ...
        <div style={{ marginBottom:64, animation:'fadeUp .5s ease .15s both' }}>
          <h2 style={{ fontSize:20, fontWeight:900, color:'#0F172A', textAlign:'center', marginBottom:8, letterSpacing:-0.4 }}>MunTalk vs Other AI Tutors</h2>
            ...
            <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13, minWidth:520 }}>
              <thead>
                <tr style={{ background:'#F8FAFC' }}>
                  ...
                  <th style={{ padding:'14px 18px', fontWeight:900, color:'#0F172A' }}>Others</th>
                </tr>
              </thead>
              <tbody>
                {([
                  ['Monthly price', '$0 forever', '$9.99', 'Up to $30'],
                  ['AI conversation practice', '3 chats / day', 'Unlimited', 'Included'],
                  ['Real-time pronunciation scoring', '✓', '✓', '—'],
                  ['CEFR completion certificates', '✓', '✓', '—'],
                  ['Languages', '90+', '90+', 'Fewer'],
