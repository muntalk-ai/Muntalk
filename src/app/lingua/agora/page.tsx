...
const S: Record<string,React.CSSProperties> = {
  ...
  navBack:{background:'#F1F5F9',border:'none',borderRadius:10,padding:'7px 14px',color:'#64748B',fontSize:13,fontWeight:700,cursor:'pointer',fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif"},
  ...
  subBtn:{padding:'9px 12px',borderRadius:10,border:'1px solid',fontSize:12,fontWeight:700,cursor:'pointer',fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif",lineHeight:1.4,background:'#fff'},
  ...
  sideSelectorBtn:{flex:1,maxWidth:180,padding:'12px 8px',border:'none',borderBottom:'2px solid transparent',background:'transparent',fontSize:13,fontWeight:800,cursor:'pointer',fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif",transition:'all .2s',letterSpacing:.3},
  ...
  translateBtn:{background:'#F1F5F9',border:'1px solid #E2E8F0',borderRadius:8,padding:'3px 10px',fontSize:12,cursor:'pointer',fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif",color:'#64748B',fontWeight:700,flexShrink:0,transition:'all .15s'},
  quickRow:{display:'flex',gap:6,padding:'8px 12px',overflowX:'auto',flexShrink:0,background:'#fff',borderTop:'1px solid #F1F5F9'},
  quickBtn:{flexShrink:0,padding:'6px 12px',borderRadius:8,border:'1px solid',background:'transparent',fontSize:11,fontWeight:700,cursor:'pointer',fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif",whiteSpace:'nowrap'},
  ...
  input:{flex:1,padding:'11px 16px',borderRadius:12,background:'#F8FAFC',border:'1.5px solid',color:'#0F172A',fontSize:14,fontFamily:"'Nunito','Noto Sans Arabic','Noto Sans Hebrew','Noto Sans Thai','Noto Sans Devanagari','Noto Sans KR','Noto Sans SC',sans-serif",outline:'none',fontWeight:600},
